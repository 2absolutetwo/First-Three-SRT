...
type Tab = "editor" | "maker" | "note" | "splitter" | "merger" | "audio" | "video" | "cuttingPlus" | "cutting";
...
export default function App() {
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-100 dark:bg-gray-900 overflow-hidden">
      ...
      {/* Other tabs */}
      <main
        style={{ display: activeTab === "maker" || activeTab === "note" || activeTab === "splitter" || activeTab === "merger" || activeTab === "audio" || activeTab === "video" || activeTab === "cuttingPlus" || activeTab === "cutting" ? "none" : "block" }}
